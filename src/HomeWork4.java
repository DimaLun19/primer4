...
public class HomeWork4 {
    ...
    public static List<String> correctedList(List<String> stringList) {int x = 0;
        ArrayList<String> strings = new ArrayList<>();
        ArrayList<String> strings1 = new ArrayList<>();
        for (String i : stringList) {strings.add(i.toLowerCase());}
        for (String i : strings)
        {if (i.equals(stringList.get(x)))
        {strings1.add(i);}
        x = x + 1;}
        return strings1;
    }
    public static HashMap<String, Integer> magSort(HashMap<String, Integer> shopCart) {int y = 0;
        ArrayList<String> values = new ArrayList<>(shopCart.keySet());
        ArrayList<Integer> values2 = new ArrayList<>(shopCart.values());
        ArrayList<Integer> values3 = new ArrayList<>();
        shopCart.clear();
        for (int i : values2)
        {if (i <= 300) values3.add(i);}
        for (int i : values3)
        {shopCart.put(values.get(y), i);
        y = y + 1;}
        return shopCart;
    }
